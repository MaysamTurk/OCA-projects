...
var length = document.getElementById("length"); //  show the message box

getMessage = function getMessage(ID) {
  document.getElementById("message").style.display = "block";
};

GoOut = function GoOut(ID) {
...
var userName = document.getElementById("name"); // When the user starts to type something inside the user Name field
...
var Email = document.getElementById("email"); // When the user starts to type something inside the email field
...
var Phone = document.getElementById("phone"); // When the user starts to type something inside the phone field
